...
/** Admin profile page: reads and updates the signed-in admin's name and phone. */
@Component({
...
export class AdminProfileComponent implements OnInit {
  ...
  /** Loads fresh admin data using the ID saved after login. */
  load(): void {
  ...
  /** Saves only name and phone, which are allowed for an admin account. */
  onSave(): void {
